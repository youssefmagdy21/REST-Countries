...
export default function BorderCountryLink({
  ...
  return (
    <Link
      ...
      className="bg-accent block h-[30px] min-w-24 rounded-sm px-2 py-1.5 text-center text-xs/4 transition-transform duration-300 hover:-translate-y-1 md:text-sm/4"
